...
def update_zone_status(
    ...
    *,
    ...
    setpoint_override_scheduled_value: Optional[float] = None,
    ...
    if setpoint_override_scheduled_value is not None:
        assignments.append("SetpointOverrideScheduledValue = ?")
        params.append(setpoint_override_scheduled_value)
        logger.info(f"Setting override_scheduled_value: {setpoint_override_scheduled_value}")
    if clear_override:
        ...
        assignments.append("SetpointOverrideScheduledValue = NULL")
